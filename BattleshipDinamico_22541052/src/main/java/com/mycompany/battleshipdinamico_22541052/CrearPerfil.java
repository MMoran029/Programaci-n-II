...
public class CrearPerfil {
    ...
    public CrearPerfil(){
        ...
        // BCrearusuario 
        ImageIcon IBCrearUsuario = new ImageIcon("src/img/BSiguiente.png");
        JButton BCrearUsuario = new JButton(IBCrearUsuario);
        BCrearUsuario.setBounds(660, 535, 300, 100);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(usuario.isEmpty() || password.isEmpty()){
            ...
            // C  battleship para registrar
            boolean registrado = Battleship.registrarJugador(usuario, password);
            
            if(!registrado){
                JOptionPane.showMessageDialog(ventana, "El usuario ya existe");
            } else {
                JOptionPane.showMessageDialog(ventana, "Perfil creado exitosamente! Ahora puedes iniciar sesión.");
